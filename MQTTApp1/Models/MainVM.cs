...
namespace MQTTApp1.Models
{
    public class MainVM : ViewModelBase
    {
        ...
        private string[] currentTopic = new string[] { "Application1/Message", "Application1/Typing" };
        private string targetTopic = "Application2/Message";
        private string targetTyping = "Application2/Typing";
